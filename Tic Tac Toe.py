...
# x and o's conditions, 1's are X, 2's are O's
...
a = b = c = d = e = f = g = h = i = True  # checks the boxes whether they are filled or not
board = [[0, 0, 0], [0, 0, 0], [0, 0, 0]]  # keeps track of x and o positions

# Display winner

gamefont = pygame.font.Font('freesansbold.ttf', 50)  # text
...
while Running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if first.collidepoints(pos) and a:
                if draw_object == 'rect':
                    screen.blit(x, (50, 50))
                    draw_object = 'circle'
                    board[0][0] = 1
            ...
            if second.collidepoint(pos) and b:
                if draw_object == 'rect':
                    ...
                    board[0][1] = 2
                b = False
            if third.collidepoints(pos) and c:
                if draw_object == 'rect':
